...
class kMeans():
    ...
    def printClusterText(self):
        ...
        with open('mylogfile.txt','w') as log_file:
          for k in self.clusters:
            for ID in self.clusters[k]:
#                 print(self.tweets[ID]['text'])
                log_file.write(self.tweets[ID]['text'])
#             print("\n")
            log_file.write('\n')
...
#         exit(-1)
#     sys.argv[1] = "Tweets.json"
#     sys.argv[2] = "InitialSeeds.txt"
